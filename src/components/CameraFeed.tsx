...
const CameraFeed: React.FC<CameraFeedProps> = ({ onAnalysisComplete }) => {
    ...
    // API Endpoint (Proxied via Vite to bypass CORS)
    const API_URL = "/api";
    ...
    return (
        <div className="relative w-full max-w-2xl mx-auto rounded-xl overflow-hidden shadow-2xl border-2 border-slate-700">
            {/* Webcam Feed */}
            <Webcam
                audio={false}
                ref={webcamRef}
